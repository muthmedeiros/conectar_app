...
import 'package:conectar_app/features/clients/presentation/controllers/edit_client_controller.dart';
...
void main() {
  ...
  late EditClientController controller;

  setUp(() {
    mockRepo = MockClientRepository();
    mockAuth = MockAuthController();
    controller = EditClientController(repo: mockRepo, auth: mockAuth);
  });

  test('controller initializes', () {
    expect(controller, isA<EditClientController>());
  });
}
